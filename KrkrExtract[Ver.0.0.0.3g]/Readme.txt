...
Version 0.0.0.3g
Fixed some bugs(Maybe no important)

Version 0.0.0.3f
Fixed png extraction.(eg : 恋がさくころ桜どき)
At present, KrkrExtract will only use 'System mode' for png extraction.
As soon as I'm free, I will write a better GUI.
