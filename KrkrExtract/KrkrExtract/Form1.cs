...
namespace KrkrExtract
{
    ...
    public partial class KrkrExtract : Form
    {
        ...
        public static extern IntPtr CreateProcessInternalWithDll([MarshalAs(UnmanagedType.LPWStr), In]string ProcessName, KrkrMode Mode);
        ...
        private void KrkrExtract_DragDrop(object sender, DragEventArgs e)
        {
            ...
            IntPtr RemoteProcess = CreateProcessInternalWithDll(ProgramName, m_Mode);
            if (RemoteProcess == NativeHelper.INVALID_HANDLE_VALUE)
            {
