...
#define ALPC_PORFLG_ENABLE_HANDLE_DUPLICATION 0x80000 // ???
...
#define ALPC_MESSAGE_ALL_ATTRIBUTE (ALPC_MESSAGE_SECURITY_ATTRIBUTE | \
   ALPC_MESSAGE_VIEW_ATTRIBUTE | ALPC_MESSAGE_CONTEXT_ATTRIBUTE | \
   ALPC_MESSAGE_HANDLE_ATTRIBUTE | ALPC_MESSAGE_TOKEN_ATTRIBUTE |\
   ALPC_MESSAGE_DIRECT_ATTRIBUTE | ALPC_MESSAGE_WORK_ON_BEHALF_ATTRIBUTE)
// end_rev
